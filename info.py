...
Bot_cmds = {
    ...
    "bot2": "File Delivery Bot Control Panel (Admin Only)",
}

# ============================
# Bot 2 (File Delivery Bot) Environment Seed (Optional)
# ============================
BOT2_TOKEN = environ.get('BOT2_TOKEN', None)
BOT2_FALLBACK_TO_BOT1 = is_enabled(environ.get('BOT2_FALLBACK_TO_BOT1'), True)
